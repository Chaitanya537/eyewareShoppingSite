<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="computerglasses.aspx.cs" Inherits="eyewareShoppingSite.computerglasses" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="auto-style1">
           ...
           <p style="color:white">Track Order</p>
            <asp:Button class ="Button2" runat="server" Text="Track Order" OnClick="Unnamed_Click2" />
            <asp:Button ID="sample" class ="Button2" runat="server" Text="User Details" OnClick="Unnamed_Click1" />
        ...
        <div class="auto-style7">
            ...
            <table>
                <tr><input type="checkbox" class="pl" /><p class="itemBox1"> COMPUTER GLASSES </p></tr>               
            </table>

            <input id="result" type="button" value="MORE FILTERS &#8744;" />
        </div>
        <div class="auto-style8">
        <asp:DataList ID="DataList1" runat="server" DataKeyField="id" DataSourceID="SqlDataSource1" Width="979px" Height="1194px" RepeatColumns="3" RepeatDirection="Horizontal" CellSpacing="2" CssClass="auto-style9" CellPadding="35" OnItemCommand="command" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
            <ItemTemplate>
                <div class="products">
                    <input type="checkbox" style=" margin-top: 10px; margin-left: 415px; width: 20px; height: 20px;"/>                
                    ...
                    <asp:Button class="buttonProduct" runat="server" Text="Buy now" OnClick="Unnamed_Click" CommandArgument= '<%# Eval("id") %>' CommandName="addToCart" />
                </div>            
            </ItemTemplate>
         </asp:DataList>
        <ItemTemplate>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DIT-TrainingConnectionString6 %>" SelectCommand="SELECT * FROM [chaitanya_eyewearadminproduct] WHERE ([type] = @type)">
            <SelectParameters>
                <asp:Parameter DefaultValue="kids wear" Name="type" Type="String" />
            </SelectParameters>
            </asp:SqlDataSource>
    </div>
   </form>
