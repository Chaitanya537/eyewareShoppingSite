<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QRpayment.aspx.cs" Inherits="eyewareShoppingSite.QRpayment" %>
    ...
    <form id="form1" runat="server">      
        ...
        <div class ="address">
            ...
            <div class="auto-style7">
                ...
                <asp:Button ID="Button7" runat="server" Text="UPI QR Code" />
                <asp:Button ID="Button8" runat="server" Text="Paytm" />
            ...
            <div>
                <img alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGD8h0S_RgAu_9ITKyS3R34f_RJvwYYk-P5GruHDNFEeErJB8uW0W81TytVu7EgQmF4SU&usqp=CAU" class="qr"/>
                <asp:Button ID="Button12" runat="server" Text="Place Order" CssClass="auto-style9" PostBackUrl="~/invoice.aspx" />
            </div>
              <h2 style ="position:relative; top:-220px">Lenskart Assurance</h2>
