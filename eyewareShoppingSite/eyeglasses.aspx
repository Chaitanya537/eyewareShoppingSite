<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eyeglasses.aspx.cs" Inherits="eyewareShoppingSite.eyeglasses" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="auto-style7">
            ...
            <table>
                <tr> <input type="checkbox" class="pl" /><p class="itemBox1"> EYE GLASSES </p></tr>               
            </table>

            <input id="result" type="button" value="MORE FILTERS &#8744;" />
        </div>
        <div class="auto-style8">
            <asp:DataList ID="DataList1" runat="server" DataKeyField="id" DataSourceID="SqlDataSource1" CellPadding="20" CellSpacing="2" RepeatColumns="3" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand">
                <ItemTemplate>
                   <div class="products">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DIT-TrainingConnectionString3 %>" SelectCommand="SELECT * FROM [chaitanya_eyewearadminproduct] WHERE ([type] = @type)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="eye glasses" Name="type" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
