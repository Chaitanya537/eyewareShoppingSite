<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addPageDelete.aspx.cs" Inherits="eyewareShoppingSite.addPageDelete" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="auto-style7">
            ...
            <asp:Button ID="Button5" CssClass="adminop" runat="server" Text="DELETE PRODUCT" />
        </div>        

        <div class="auto-style8" align="center">
            <h1 class="adminheading">ADMIN INFORMATION FOR DELETING DATA</h1>
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Gray" BorderWidth="2px" CssClass="button" DataKeyNames="id" EmptyDataText="No Record to Display" HeaderStyle-BorderColor="Gray" HeaderStyle-BorderWidth="3px" Font-Size="Large" PageSize="4" Width="300px" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">

                <Columns>
                    <asp:TemplateField HeaderText="Category">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox2" runat="server" Font-Bold="True" Text='<%# Eval("name") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
...
<HeaderStyle BorderColor="Gray" BorderWidth="3px"></HeaderStyle>
