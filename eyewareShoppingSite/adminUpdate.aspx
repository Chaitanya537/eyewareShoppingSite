<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminUpdate.aspx.cs" Inherits="eyewareShoppingSite.adminUpdate" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="auto-style7">
            ...
            <asp:Button ID="Button2" CssClass="adminop" runat="server" Text="INSERT PRODUCT" PostBackUrl="~/adminPageInsert.aspx" />
            <asp:Button ID="Button4" CssClass="adminop" runat="server" Text="UPDATE PRODUCT" />
        ...
        <div class="auto-style8" align="center">
            <h1 class="adminheading">ADMIN INFORMATION FOR UPDATING DATA</h1>
            <br /><br /><br />
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="category" DataValueField="category" Height="50px" Width="287px">

            </asp:DropDownList>
            
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DIT-TrainingConnectionString7 %>" SelectCommand="SELECT [category] FROM [chaitanya_eyecat]"></asp:SqlDataSource>
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" EmptyDataText="No Data Available" OnPageIndexChanging="GridView1_PageIndexChanging1" OnRowCancelingEdit="GridView1_RowCancelingEdit1" OnRowEditing="GridView1_RowEditing1" OnRowUpdating="GridView1_RowUpdating1">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="size">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox3" runat="server" Text='<%# Eval("size") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Image">
                        ...
                        <ItemTemplate>
                            <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("image") %>' height="100px" Width="90px" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="ratings">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox5" runat="server" Text='<%# Eval("rating") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="type">
                        <EditItemTemplate>
                            <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource2" DataTextField="category" DataValueField="category" SelectedValue='<%# Eval("type") %>'>
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DIT-TrainingConnectionString9 %>" SelectCommand="SELECT * FROM [chaitanya_eyecat]"></asp:SqlDataSource>
                        </EditItemTemplate>
                        <ItemTemplate>
