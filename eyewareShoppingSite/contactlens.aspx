<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contactlens.aspx.cs" Inherits="eyewareShoppingSite.contactlens" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="auto-style7">
            ...
            <table>
                <tr> <input type="checkbox" class="pl" /><p class="itemBox1"> CONTACT LENSES </p></tr>               
            </table>

            <input id="result" type="button" value="MORE FILTERS &#8744;" />
        </div>
        <div class="auto-style8">
            <asp:DataList ID="DataList1" runat="server" DataKeyField="id" DataSourceID="SqlDataSource2" CellPadding="20" CellSpacing="2" RepeatColumns="3" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand">
                <ItemTemplate>
                    <div class="products">
                    ...
                    <h4 style="position:relative; margin-left:20px;top:10px"> &#8377;<asp:Label ID="priceLabel" runat="server" Text='<%# Eval("price") %>' /> <s style="color:darkgray">&#8377; <asp:Label ID="Label5" runat="server" Text='<%# Eval("originalPrice") %>'></asp:Label></s> (+tax)</h4>
                     <asp:Button class="buttonProduct" OnClick="Unnamed_Click1" runat="server" Text="Buy now" CommandArgument='<%#Eval("id") %>' CommandName="AddtoCart"/>
                </div>            
                </ItemTemplate>
            </asp:DataList>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DIT-TrainingConnectionString4 %>" SelectCommand="SELECT * FROM [chaitanya_eyewearadminproduct] WHERE ([type] = @type)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="contact lenses" Name="type" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
